...
async function main() {
  ...
  await prisma.review.createMany({
    data: [
      {
        authorName: "Гизатуллина Светлана",
        text: "Как хорошо, что в городе появилась семейная сауна. Это очень здорово, что можно всей семьей провести время. Для детей тоже есть где порезвиться. Отличная сауна, а бассейн, особенно с джакузи, выше всяких похвал. Администратор тоже на высоте.",
        rating: 5,
        source: "2gis",
        sourceId: "2gis-review-1",
        branchId: branch9.id,
        isApproved: true,
        isVisible: true,
      },
      {
        authorName: "Артур",
        text: "Приехали с друзьями, заранее бронировали, ни минуты не пришлось ждать. Чистота радует и вежливый администратор.",
        rating: 5,
        source: "2gis",
        sourceId: "2gis-review-2",
        branchId: branch9.id,
        isApproved: true,
        isVisible: true,
      },
      {
        authorName: "Альбина",
        text: "Всей семьёй с грудным ребенком ходили в этот замечательный комплекс. Всё супер! Чисто, уютно. Персонал добрый, приветливый!",
        rating: 5,
        source: "2gis",
        sourceId: "2gis-review-3",
        branchId: branch9.id,
        isApproved: true,
        isVisible: true,
      },
      {
        authorName: "Алексий",
        text: "Хорошая сауна, чисто, парилка хорошая, бассейн особенно понравился.",
        rating: 5,
        source: "2gis",
        sourceId: "2gis-review-4",
        branchId: branch9.id,
        isApproved: true,
        isVisible: true,
      },
      {
        authorName: "Ландыш Аглеева",
        text: "Отличное место для отдыха. Красиво, уютно, тепло, и самое главное — чисто.",
        rating: 5,
        source: "2gis",
        sourceId: "2gis-review-5",
        branchId: branch9.id,
        isApproved: true,
        isVisible: true,
      },
      {
        authorName: "Динара Исхакова",
        text: "Побывали с детьми в семейной сауне Сакура. Всё так современно, красиво, чисто.",
        rating: 5,
        source: "2gis",
        sourceId: "2gis-review-6",
        branchId: branch9.id,
        isApproved: true,
        isVisible: true,
      },
      {
        authorName: "Светлана Ахметвалеева",
        text: "Отличное место для отдыха семьёй и для празднования дня рождения, чисто, уютно, приятная атмосфера.",
        rating: 5,
        source: "2gis",
        sourceId: "2gis-review-7",
        branchId: branch9.id,
        isApproved: true,
        isVisible: true,
      },
      {
        authorName: "Тахир Худайбердин",
        text: "Выбирали сауну с бассейном, выбор пал на Сакуру. И не пожалели — мы точно теперь ваши постоянные посетители!",
        rating: 5,
        source: "2gis",
        sourceId: "2gis-review-8",
        branchId: branch9.id,
        isApproved: true,
        isVisible: true,
      },
      {
        authorName: "Елена Курбатова",
        text: "Отличное место для отдыха в черте города. Есть залы с хамамом, с финской сауной и с русской. Всем рекомендую!",
        rating: 4,
        source: "2gis",
        sourceId: "2gis-review-9",
        branchId: branch9.id,
        isApproved: true,
        isVisible: true,
      },
      {
        authorName: "Евгений Реунов",
        text: "Новый банный комплекс! Всё отлично, молодцы, держите уровень на высоте!",
        rating: 5,
        source: "2gis",
        sourceId: "2gis-review-10",
        branchId: branch9.id,
        isApproved: true,
        isVisible: true,
      },
      {
        authorName: "Асаф",
        text: "Классная сауна, были неоднократно, и с детьми и большой толпой. Всё отлично. Вежливый персонал, чистота и уют.",
        rating: 5,
        source: "2gis",
        sourceId: "2gis-review-11",
        branchId: branch9.id,
        isApproved: true,
        isVisible: true,
      },
      {
        authorName: "Морозов Олег",
        text: "Напарились в парилке с вениками, плавали в бассейне — бассейн прохладный после парилки самое то! В сауне всё чистенько, админ вежливо встретила и вежливо проводила. Придём ещё.",
        rating: 5,
        source: "2gis",
        sourceId: "2gis-review-12",
        branchId: branch50.id,
        isApproved: true,
        isVisible: true,
      },
      {
        authorName: "Юлия",
        text: "Очень хорошая сауна! Просто обожаем эту сеть! Тут всегда так чисто, уютно и гостеприимно, спасибо!",
        rating: 5,
        source: "2gis",
        sourceId: "2gis-review-13",
        branchId: branch50.id,
        isApproved: true,
        isVisible: true,
      },
      {
        ...
        text: "Были в гостях в Набережных Челнах, и решили посетить сауну Сакура. Отличная сауна. Нам понравился интерьер, обслуживание на высшем уровне, и главное — чистота.",
        rating: 5,
        source: "2gis",
        sourceId: "2gis-review-14",
        branchId: branch50.id,
        isApproved: true,
        isVisible: true,
      },
      {
        authorName: "Travel Girl",
        text: "Выбрала джакузи, чистый был. Час — 600 руб. Неплохо, но бассейн мог быть почище.",
        rating: 3,
        source: "2gis",
        sourceId: "2gis-review-15",
        branchId: branch9.id,
        isApproved: true,
        isVisible: true,
      },
  ...
  console.log("✅ 15 reviews seeded (2GIS)");
